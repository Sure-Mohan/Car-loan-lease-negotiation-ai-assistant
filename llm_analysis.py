...
if not API_KEY:
    raise ValueError("❌ GROQ_API_KEY environment variable not set. Please export it before running.")

INPUT_TXT_FOLDER = r"C:\Users\saisu\Downloads\Car lease\output"
OUTPUT_JSON_FOLDER = r"C:\Users\saisu\Downloads\Car lease\llm_json"
    ...
    if file.lower().endswith(".txt"):
        ...
        try:
            ...
            try:
                ...
                print("⚠️ JSON parsing failed. Saving raw LLM output.")
                print("Error:", e)
                with open(json_path, "w", encoding="utf-8") as jf:
                    jf.write(llm_output)
